...
namespace qFpsControllerLPFP
{
    /// Manages a first person character
    [RequireComponent(typeof(Rigidbody))]
    [RequireComponent(typeof(CapsuleCollider))]
    [RequireComponent(typeof(AudioSource))]
    public class qFpsControllerLPFP : MonoBehaviour
    {
...
#pragma warning restore 649
        ...
        {
            var t = transform;
            arms1.SetPositionAndRotation(t.position, t.rotation);
            return arms1;
        }
        ...
        private void RotateCameraAndCharacter1()
        {
            ...
            var clampedY = RestrictVerticalRotation(rotationY);
            _rotationY.Current = clampedY;
            var worldUp = arms1.InverseTransformDirection(Vector3.up);
            var rotation = arms1.rotation *
                           Quaternion.AngleAxis(rotationX, worldUp) *
                           Quaternion.AngleAxis(clampedY, Vector3.left);
            transform.eulerAngles = new Vector3(0f, rotation.eulerAngles.y, 0f);
